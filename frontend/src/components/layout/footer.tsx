        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8">
          ...
          <div className="lg:col-span-5 flex flex-col items-start">
            ...
            <p className="text-primary text-2xl lg:text-3xl leading-[1.15] font-bold tracking-tight uppercase mb-8 max-w-xl">
              WADAH KREATIVITAS, ASPIRASI, DAN PRESTASI SISWA-SISWI SMAN 2 BABELAN.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-8 mb-24">
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li><Link href="/profil" className="text-foreground text-[15px] hover:text-primary transition-colors">Tentang Kami</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li><Link href="/profil#struktur" className="text-foreground text-[15px] hover:text-primary transition-colors">Struktur Organisasi</Link></li>
                  <li><Link href="/bph/ketua-wakil" className="text-foreground text-[15px] hover:text-primary transition-colors">Badan Pengurus Harian</Link></li>
                  <li><Link href="/sekbid" className="text-foreground text-[15px] hover:text-primary transition-colors">Seksi Bidang (Sekbid)</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  ...
                  <li><Link href="/dokumen" className="text-foreground text-[15px] hover:text-primary transition-colors">Pusat Dokumen</Link></li>
